    ...
    while (True):
        ...
        if input1 == '1':
            ...
            if input2.lower() == 'y':
                ...
                filename = await twitterAPI.main();
                print('Starting sentiment analysis...')
                await sentimentCacher.beginCache(filename);
            ...
            if input3 == '1':
                ...
                await single_tweet_analysis(input4);
            elif input3 == '2':
                input5 = input("Please enter the username of the user. ")
                await single_user_analysis(input5);
            else:
